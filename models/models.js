...
module.exports = sequelize => {
  ...
  const XiaoQu = sequelize.define(
    'XiaoQu',
    {
      id: { type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true },
      name: { type: Sequelize.STRING },
      tags: { type: Sequelize.JSON },
      buildTime: { type: Sequelize.DATE },
      price: { type: Sequelize.INTEGER },
      toSellHouse: { type: Sequelize.INTEGER },
      url: { type: Sequelize.STRING },
      ljId: { type: Sequelize.STRING },
      district: { type: Sequelize.STRING }, // 区域名
      selectTime: Sequelize.CHAR(10), // 数据采集时间
    },
    {
      freezeTableName: true,
    },
